...
#######                                          #########
#######                                          #########
fileEnergy = open("4deut_energies.txt", "a+")
fileXYZ = open("4deut_ancestors.xyz", "a+")
fileHistData = open("4deut_histdata.txt", "a+")
fileBinEdges = open("4deut_binedges.txt", "a+")
timestep = 0
energies = []
population = []
ancestorPile = []
...
for c in range(0,cycles):    
	...
	for i in range(0,len(displace)): 
		...
		displace[i,5,:] = np.random.normal(0,sigma2,(1,3))
